...
void loop() {
  ...
  for (uint8_t i=0; i<12; i++) {
    ...
    if ((currtouched & _BV(i)) && !(lasttouched & _BV(i)) ) {
      ...
      int absoluteDifference = abs((int)cap.filteredData(i) - (int)cap.baselineData(i));
    Serial.println(absoluteDifference);
    }
